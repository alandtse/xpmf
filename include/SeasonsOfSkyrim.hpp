 ...
 * that material's profile's vertex colors and roof shelter. And its projection color is brought
 * in line with what the record says now (unless the record was left untouched - a True PBR
 * configuration, patchMaterial off), which is what makes its draws the profile's.
